...
export const translations = {
  ja: {
    ...
    aboutVersion:
      "現在EA 23.295 安定版の仕様に基づいています。選択肢にそのバージョンまでのキャラなどが表示されない場合は、スーパーリロード（Ctrl + Shift + R）を試してみてください。",
    aboutSimulatorTab:
  ...
  en: {
    ...
    aboutVersion:
      "Currently based on EA 23.295 stable version specifications. If characters up to that version are not displayed in the options, try a hard refresh (Ctrl+Shift+R or Cmd+Shift+R).",
    aboutSimulatorTab:
